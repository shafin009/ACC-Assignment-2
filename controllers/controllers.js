const { getTourService, makeTour, findTourId, updateTourId, findTrending, findCheapest } = require("../model/service");
...
exports.getAllTour = async (req, res) => {
    try {
        ...
        filterFields = filterFields.replace(/\b(gt|gte|lt|lte)\b/g, match => `$${match}`);
